...
const defaultExcuses = [
    ...
    { id: "6", text: " يمنع زيارة المستفيدين من الجنس الآخر (المستقلين) دون وجود المحرم الشرعي." },
    { id: "7", text: " يحظر إتمام الزيارة عن بعد دون توجيه رسمي وخطي من إدارة المشروع." },
    { id: "8", text: " يمنع توقيع الباحث بدلًا عن المستفيد أو في غير الحقل المخصص لتوقيعه" },
];
